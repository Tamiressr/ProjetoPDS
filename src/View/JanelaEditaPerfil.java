...
public class JanelaEditaPerfil{
	 ...
	 */
	public JanelaEditaPerfil(String cnpj) {
		this.cnpj=cnpj;
		initialize();
		colocarDados();
	}
	...
	private void initialize() {
		...
		OuvinteAtualizarPerfil ouvinteAtualizarPerfil=new OuvinteAtualizarPerfil(frame,cnpj);
		...
		OuvinteJanelaPerfil ouvinteJanelaPerfil=new OuvinteJanelaPerfil(frame, cnpj);
	...
	public void colocarDados() {
		List<String> list=Facade.getFacade().procurarEscolaPorCNPJ(cnpj);
